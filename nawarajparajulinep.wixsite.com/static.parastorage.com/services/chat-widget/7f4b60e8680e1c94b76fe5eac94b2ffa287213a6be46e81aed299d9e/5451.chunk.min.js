    ...
    [5451], {
        85451: function(t, e, n) {
            ...
            var I = function() {
                    function t(t) {
                        var e, n, o = this,
                            r = t.getPresenceConnection,
                            s = t.scope,
                            c = t.getSignedInstance,
                            a = t.initialState,
                            u = void 0 === a ? {} : a,
                            p = t.keepAliveInterval,
                            I = void 0 === p ? v : p,
                            _ = t.isIdleMs,
                            m = t.onIdle,
                            S = t.onActive;
                        this.onStateChangeFn = function() {}, this.sessionId = l(), this.trackState = d.INIT, this.lastInactivity = null, this.list = [], this.onDisconnectFn = function() {}, this.shuoldWatchGroup = !0, this.onIdle = function() {
                        ...
                        }, this.getPresenceConnection = r, this.getSignedInstance = c, this.keepAliveInterval = I, this.scope = s, this.storeState(u), this.isIdleMs = null !== (n = null !== (e = window.__PRESENCE_IDLE_TIME) && void 0 !== e ? e : _) && void 0 !== n ? n : 6e5, this.onIdleFn = null != m ? m : function() {}, this.onActiveFn = null != S ? S : function() {}, this.idle = h({
                    ...
                    return t.prototype.initPresenceApi = function() {
                        ...
                        this.onStateChangeFn(p(this.list), t ? p(t) : void 0)
                        ...
                        return t.activity = function(t) {
                            ...
                            return t !== i
                        }))), t.status === r.ONLINE && this.list.push(t), f.STATE)
            ...
            var S = "_",
                g = /{(.*)}/,
                y = new RegExp("\\.(".concat(["wix.com", "editorx.com"].join("|"), ")$")),
                T = new RegExp("\\.(".concat(["42.wixprod.net"].join("|"), ")$"));
            ...
            function E(t) {
                var e, n, i = function(t, e) {
                    ...
                    }(t.host).replace(y, "._base_domain_").replace(T, "._api_base_domain_"), t.domainToMappings),
                    o = (e = t.protoPath, n = t.data || {}, e.split("/").map((function(t) {
                        return function(t, e) {
                            var n = t.match(g) || [],
                                i = n[1];
                            if (i) {
                                ...
                                return function(t, e, n, i) {
                                    for (var o = t, r = 0, s = e.split("."); r < s.length; r++) {
                                        var c = s[r];
                                        if (!o) return n;
                                        o = o[c]
                                    }
            ...
            var w, O, A = "www._base_domain_";

            function b(t, e, n) {
                return void 0 === e && (e = {}),
                    function(i, o) {
                        return void 0 === i && (i = {}), "string" == typeof i ? i : r(t, i);

                        function r(t, e) {
                            var n = {};
                            return [null, void 0].includes(e) ? e : (Object.entries(e).forEach((function(e) {
                                var i, o, r, a, u = e[0],
                                    h = e[1],
                                    l = function(t) {
                                        void 0 === t && (t = "");
                                    ...
                                    p = l.schemaName,
                                    d = "Map" === l.schemaType;
                                a = (null !== (r = null === (o = null === (i = c(p)) || void 0 === i ? void 0 : i.checkRepetable) || void 0 === o ? void 0 : o.call(i, h)) && void 0 !== r ? r : Array.isArray(h)) ? h.map((function(t) {
                                    return s(t, p)
                                })) : d ? function(t, e) {
                        ...
                        function c(t) {
                            var e;
                            return null === (e = n[t]) || void 0 === e ? void 0 : e[o]
                        }
                    }
            }! function(t) {
                ...
                R = ((x = {
                    ...
                    transform: function(t) {
                        var e = t.seconds,
                            ...
                            o = void 0 === i ? 0 : i,
                            r = "";
                        return 0 !== o && (r = ".".concat(o.toString().padStart(9, "0"))), "".concat(n).concat(r, "s")
                    }
                }, x[w.FROM_JSON] = {
                    transform: function(t) {
            ...
            var G = function(t, e, n) {
                ...
                V = G([], [k, P, F, R, J], !0).reduce((function(t, e) {
                    var n = e.types.reduce((function(t, n) {
                        var i;
                        return L(L({}, t), ((i = {})[n] = e, i))
                    }), {});
                    return L(L({}, t), n)
                }), {});
            ...
            function W(t, e) {
                ...
                return {
                    fromJSON: function(t) {
                        ...
                        return n(e, w.FROM_JSON)
                    },
                    toJSON: function(t) {
                        return n(t, w.TO_JSON)
                    }
                }
            }
            var B, U, j, X = {
            ...
            var Z = function() {
                    function t(t) {
                        var e, n, o = this,
                            ...
                            I = t.onIdle,
                            _ = t.onActive;
                        this.sessionId = l(), this.onDisconnectFn = function() {}, this.shouldWatchGroup = !0, this.onIdle = function() {
                        ...
                        }, this.getPresenceConnection = r, this.keepAliveInterval = d, this.scope = this.convertScope(s), this.isIdleMs = null !== (n = null !== (e = window.__PRESENCE_IDLE_TIME) && void 0 !== e ? e : f) && void 0 !== n ? n : 6e5, this.onIdleFn = null != I ? I : function() {}, this.onActiveFn = null != _ ? _ : function() {}, this.getInitialState = u, this.idle = h({
                            isIdleTime: this.isIdleMs,
                            onIdle: this.onIdle,
                            onActive: this.onActive
                        }), this.httpClient = c
                    ...
                    return t.prototype.track = function(t) {
                        ...
                        return void 0 === e && (e = []), (0, i.__awaiter)(this, void 0, void 0, (function() {
                            ...
                            return (0, i.__generator)(this, (function(i) {
                                switch (i.label) {
                                    case 0:
                                        return n = this.preparePayload(t), o = n.payload, r = n.mask, s = Array.from(new Set(r.concat(e))), [4, this.updateState({
                                            mask: s,
                                            presence: {
                                                payload: o,
                                                scope: this.scope,
                ...
                et = function() {
                    ...
                    return t.prototype.group = function(t, e) {
                        var n = this;
                        ! function(t) {
                            if (!Object.values(s).includes(t)) throw new Error("scope " + t + " is invalid!")
                        }(t);
                        return new _({
