        ...
        return function() {
            ...
            function u(e) {
                ...
                if ("string" == typeof e || "number" == typeof e) n += e;
                    ...
                    if (Array.isArray(e))
                        for (t = 0; t < e.length; t++) e[t] && (r = u(e[t])) && (n && (n += " "), n += r);
                    else
                        for (t in e) e[t] && (n && (n += " "), n += t);
                return n
            }
            var a = function() {
                for (var e, t, r = 0, n = ""; r < arguments.length;)(e = arguments[r++]) && (t = u(e)) && (n && (n += " "), n += t);
                return n
            };
            ...
            var b = "aVng1S";
            const v = {
                FiveGridLine_SolidLine: {
                    component: e => {
                        let {
                            children: r,
                            ...n
                        } = e;
                        return i().createElement(p, t()({}, n, {
                            className: a(n.className, b)
                        }))
                    }
                }
            }
