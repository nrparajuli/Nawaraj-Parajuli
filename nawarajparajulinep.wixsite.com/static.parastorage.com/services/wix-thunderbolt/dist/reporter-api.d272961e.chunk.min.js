(self.webpackJsonp__wix_thunderbolt_app = self.webpackJsonp__wix_thunderbolt_app || []).push([
    [5921], {
        43819: function(e) {
            "undefined" != typeof self && self, e.exports = function() {
                ...
                return function() {
                    ...
                    for (var d = /^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000)$/i, p = function(e) {
                            return "string" == typeof e && d.test(e)
                        }, v = [], l = 0; l < 256; ++l) v.push((l + 256).toString(16).substr(1));
                    var f = function(e) {
                            var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
                                t = (v[e[n + 0]] + v[e[n + 1]] + v[e[n + 2]] + v[e[n + 3]] + "-" + v[e[n + 4]] + v[e[n + 5]] + "-" + v[e[n + 6]] + v[e[n + 7]] + "-" + v[e[n + 8]] + v[e[n + 9]] + "-" + v[e[n + 10]] + v[e[n + 11]] + v[e[n + 12]] + v[e[n + 13]] + v[e[n + 14]] + v[e[n + 15]]).toLowerCase();
                            if (!p(t)) throw TypeError("Stringified UUID is invalid");
                            return t
                        },
                        m = function(e, n, t) {
                    ...
                    var E = ["type"],
                        ...
                        P = {
                            ...
                            InitiateCheckout: function(e) {
                                return [
                                    ["track", "InitiateCheckout", a()({}, T(L(e)), e.contents && {
                            ...
                            AddPaymentInfo: function(e) {
                                return [
                                    ["track", "AddPaymentInfo", a()({}, T(L(e)), e.contents && {
                                        content_ids: e.contents.map((function(e) {
                                            return e.id
                                        })),
                                        content_type: "product"
                            ...
                            Purchase: function(e, n) {
                                ...
                                return [
                                    ["track", "Purchase", a()({}, T(L(e)), e.contents && {
                                        content_ids: e.contents.map((function(e) {
                                            return e.id
                                        })),
                                        content_type: "product"
                            ...
                            CustomEvent: function(e) {
                                var n = e.event,
                                    t = e.eventAction;
                                return [
                                    ["trackCustom", n || (void 0 === t ? "customEvent" : t), y()(e, k), {
                                        eventID: e._internalEventId
                                    }]
                                ]
                            }
                    ...
                    ! function() {
                        for (var e = 1; e <= 200; e++) N["dimension" + e] = "dimension" + e, N["metric" + e] = "metric" + e
                    }();
                    var x = function(e) {
                        ...
                        G = {
                            ...
                            ClickProduct: function(e) {
                                ...
                                return [
                                    ...
                                    ["send", "event", x(e.origin), "Product Click", n]
                                ])
                            },
                            ViewContent: function(e) {
                                var n = e.name ? e.name : "(not set)";
                                return [
                                    ...
                                    ["ec:addImpression", I(e, N)]
                                ]).concat([
                                    ["ec:setAction", "detail"]
                                ]).concat([
                                    ["send", "event", x(e.origin), "View Content", n, {
                                        nonInteraction: !0
                                    }]
                                ])
                            },
                            AddToCart: function(e) {
                                ...
                                return [
                                    ...
                                    ["send", "event", x(e.origin), "Add to Cart", n]
                                ])
                            },
                            RemoveFromCart: function(e) {
                                ...
                                return [
                                    ...
                                    ["send", "event", x(e.origin), "Remove from Cart", n]
                                ])
                            },
                            InitiateCheckout: function(e) {
                                var n = (e.contents || []).map((function(e) {
                                        return ["ec:addProduct", I(e, N)]
                                    })),
                                    t = I({
                                        option: e.option
                                    }, N);
                            ...
                            CheckoutStep: function(e) {
                                ...
                                return [
                                    ...
                                    ["send", "event", x(e.origin), "Checkout Step " + n.step]
                                ])
                            },
                            Purchase: function(e) {
                                var n = (e.contents || []).map((function(e) {
                        ...
                        M = ["origin"],
                        j = ["contents", "origin"],
                        q = ["event", "eventLabel", "eventCategory"],
                        F = {
                            type: "type",
                            price: "price",
                            sku: "sku",
                    ...
                    var U = ["event", "targetTable"],
                        J = {
                            ...
                            Lead: {
                                name: function(e) {
                                    var n;
                                    return (n = e.label) && ("" + n).replace(/\s/g, "")
                                },
                                table: "lead_events"
                            }
                        };
                    ...
                    var Q = Object.keys(J).reduce((function(e, n) {
                            var t = J[n],
                                r = t.name,
                                o = t.table,
                                i = t.paramsMap;
                        ...
                        te = Object.keys(ee).reduce((function(e, n) {
                            return e[n] = function(e, t) {
                                ...
                                return t.context && t.context.appDefId && (r.appId = t.context.appDefId), t.preventDefaultChannels ? [] : ("Purchase" === n && (r.features = K({
                    ...
                    var ie, ce, ae, ue, se, de = {
                        ...
                        Ye = ((ae = {})[Fe.GOOGLE_ANALYTICS_CONSENT_MODE] = ke, ae[Fe.GOOGLE_TAG_MANAGER_CONSENT_MODE] = X, ae),
                        Be = ((ue = {})[Fe.FACEBOOK_PIXEL] = P, ue[Fe.GOOGLE_ANALYTICS] = G, ue[Fe.GOOGLE_TAG_MANAGER] = X, ue[Fe.WIX_ANALYTICS] = Q, ue[Fe.BI_ANALYTICS] = te, ue[Fe.GTAG] = de, ue[Fe.GLOBAL_GTAG] = ke, ue[Fe.VK_RETARGETING] = {
                            PageView: function() {
                                return [
                                    []
                                ]
                            }
                        }, ue[Fe.YANDEX_METRICA] = Te, ue[Fe.TIKTOK_PIXEL] = De, ue),
                        Xe = a()({}, Ye, Be),
                        Ke = ((se = {})[Fe.WIX_DEVELOPERS_ANALYTICS] = function(e, n) {
                            if (e) {
                                if (window) {
        ...
        59126: function(e, n, t) {
            "use strict";
            t.r(n), t.d(n, {
                initChannels: function() {
                    return l
                },
                initDefaultChannels: function() {
                    return m
                },
            ...
            function i(e, n, t) {
                return [r.channelNames.WIX_ANALYTICS, r.channelNames.BI_ANALYTICS].includes(n) ? function(e, n) {
                    return t => {
                        const {
                            browserLang: r,
                            preferredLang: o
                            ...
                            0;
                            null === c.browserLang && null === c.preferredLang && (c.browserLang = window.navigator.language, c.preferredLang = window.navigator.languages ? window.navigator.languages.slice(0, 5).join(",") : "");
                            return c
                        }();
            ...
            const a = e => {
                    ...
                    return window.promoteAnalyticsChannels.map((n => ({
                        name: n.name,
                        events: n.events,
                        report: i(e, n.name, n.report),
                        config: n.config
                    })))
                },
                u = (e, n) => {
            ...
            const v = (e, n, t) => [{
                    ...
                    report: i(e, r.channelNames.BI_ANALYTICS, (e => {
                        if (e.src === p.s3.SRC && e.evid === p.s3.EVID) {
                            const n = (0, s.W)();
                            e = Object.assign(Object.assign({}, e), n && (0, d.C)(t) && {
                                utmData: JSON.stringify(n)
                            })
                        }! function(e) {
                            n.logger.log(e, {
                                endpoint: p.Hw
                ...
                l = (e, n) => {
                    const t = u(e, n);
                    t.length && (r.api.init(t), window && "function" == typeof window.ga && window.ga("require", "ec"))
                },
                f = e => {
                    r.api.addListener([r.listeners[r.channelNames.WIX_DEVELOPERS_ANALYTICS]], e)
                },
                m = (e, n, t) => {
                    const o = v(e, n, t);
                    r.api.init(o), f(e)
                ...
                _ = (e, n = {}, t = {}) => {
                    r.api.trackEventToListenersOnly(e, n, t)
                }
        }
    }
]);
//# sourceMappingURL=https://static.parastorage.com/services/wix-thunderbolt/dist/reporter-api.d272961e.chunk.min.js.map